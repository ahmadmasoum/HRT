...
** Check the `ConnectionStrings` in `appsettings.json` files under the `HRT.Web` and `HRT.DbMigrator` projects and change it if you need.
**
...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p d68e6f28-9629-4490-8483-0644c6b1e4e0
```

> `d68e6f28-9629-4490-8483-0644c6b1e4e0` is the password of the certificate, you can change it to any password you want.
